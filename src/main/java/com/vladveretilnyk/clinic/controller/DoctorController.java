...
public class DoctorController {
    ...
    public String assignNursePage(@RequestParam(required = false) String sort, @RequestParam(required = false) String direction, @PathVariable Long patientId, Pageable pageable, Model model) {
